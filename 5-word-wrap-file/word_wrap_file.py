...
def wrap( input , columns ) :
    ...
    for word in words:
        ...
        if word_length>columns:
            ...
            second_part_wrapped = wrap( second_part , columns )
            chars_in_line_so_far = len(second_part_wrapped) % columns 
            output = output + second_part_wrapped
...
def main():
    ...
    # Data types. 
    # how to not execute all the functions when you import a file is by 
